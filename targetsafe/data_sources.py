...
class PublicDataSources:
    ...
    def collect_evidence(self, disease: str, target: str) -> EvidenceBundle:
        ...
        regulatory = self.get_openfda_label_risks(target)
        notes = [
        ...
        return EvidenceBundle(
            ...
            known_inhibitors=KNOWN_EGFR_INHIBITORS,
    ...
    def get_openfda_label_risks(self, target: str) -> list[dict[str, Any]]:
        ...
        if not payload:
            return FALLBACK_REGULATORY_RISKS
        ...
        return risks or FALLBACK_REGULATORY_RISKS
